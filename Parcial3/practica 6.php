...
<body style="background-color: rgb(171, 214, 255);">
    <?php
        ...
        if(isset($_POST["frase"])){($_POST["frase"]);
            ...
            if($vidas <= 0){
                ...
                echo "<a href='practica 6.html'>Regresar al inicio</a>";
                return;
            }
            $terminado = false;
            //Valida si ganó
    ...
    ?>
    <div class="container">
        <form action="practica 6.php" method="POST">
            ...
            <div class="row mt-4">
                ...
                <div>
                    <input type="submit" value="Enviar letra" class="btn btn-primary"  style="background-color: rgb(84, 162, 214);">
                </div>
            </div>
        </form>
    </div>
